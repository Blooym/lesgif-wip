...
//
// Lexicon: net.dollware.lesgif.actor.profile
//
    ...
    S: profile_state::State,
{
    ...
    pub fn build(self) -> Profile<'a> {
        Profile {
            ...
            pronouns: self.__unsafe_private_named.3,
...
impl jacquard_common::types::collection::Collection for Profile<'_> {
    const NSID: &'static str = "net.dollware.lesgif.actor.profile";
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Profile<'a> {
    ...
    fn lexicon_doc() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
        lexicon_doc_net_dollware_lesgif_actor_profile()
    }
    fn validate(
        &self,
...
fn lexicon_doc_net_dollware_lesgif_actor_profile() -> ::jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("net.dollware.lesgif.actor.profile"),
        revision: None,
        description: None,
        defs: {
