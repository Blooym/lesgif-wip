...
//
// Lexicon: net.dollware.lesgif.moderation.label
//
...
where
    S: label_state::State,
    S::Value: label_state::IsUnset,
{
    /// Set the `value` field (required)
    pub fn value(
        mut self,
        value: impl Into<jacquard_common::CowStr<'a>>,
    ) -> LabelBuilder<'a, label_state::SetValue<S>> {
...
impl jacquard_common::types::collection::Collection for Label<'_> {
    const NSID: &'static str = "net.dollware.lesgif.moderation.label";
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Label<'a> {
    ...
    fn lexicon_doc() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
        lexicon_doc_net_dollware_lesgif_moderation_label()
    }
    fn validate(
        &self,
...
fn lexicon_doc_net_dollware_lesgif_moderation_label() -> ::jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
