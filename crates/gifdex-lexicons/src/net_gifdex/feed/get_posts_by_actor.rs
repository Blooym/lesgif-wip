...
//
// Lexicon: net.gifdex.feed.getPostsByActor
//
...
pub struct GetPostsByActorBuilder<'a, S: get_posts_by_actor_state::State> {
...
impl<'a> GetPostsByActor<'a> {
    /// Create a new builder for this type
    pub fn new() -> GetPostsByActorBuilder<'a, get_posts_by_actor_state::Empty> {
        GetPostsByActorBuilder::new()
    }
}

impl<'a> GetPostsByActorBuilder<'a, get_posts_by_actor_state::Empty> {
...
where
    ...
    S::Actor: get_posts_by_actor_state::IsUnset,
{
    /// Set the `actor` field (required)
    pub fn actor(
        mut self,
        value: impl Into<jacquard_common::types::string::Did<'a>>,
    ) -> GetPostsByActorBuilder<'a, get_posts_by_actor_state::SetActor<S>> {
...
where
    S: get_posts_by_actor_state::State,
    S::Actor: get_posts_by_actor_state::IsSet,
{
    /// Build the final struct
    pub fn build(self) -> GetPostsByActor<'a> {
        GetPostsByActor {
...
pub enum GetPostsByActorError<'a> {
...
/// Response type for
///net.gifdex.feed.getPostsByActor
pub struct GetPostsByActorResponse;
impl jacquard_common::xrpc::XrpcResp for GetPostsByActorResponse {
    const NSID: &'static str = "net.gifdex.feed.getPostsByActor";
    const ENCODING: &'static str = "application/json";
    type Output<'de> = GetPostsByActorOutput<'de>;
    type Err<'de> = GetPostsByActorError<'de>;
}

impl<'a> jacquard_common::xrpc::XrpcRequest for GetPostsByActor<'a> {
    const NSID: &'static str = "net.gifdex.feed.getPostsByActor";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Response = GetPostsByActorResponse;
}

/// Endpoint type for
///net.gifdex.feed.getPostsByActor
pub struct GetPostsByActorRequest;
impl jacquard_common::xrpc::XrpcEndpoint for GetPostsByActorRequest {
    const PATH: &'static str = "/xrpc/net.gifdex.feed.getPostsByActor";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<'de> = GetPostsByActor<'de>;
    type Response = GetPostsByActorResponse;
}